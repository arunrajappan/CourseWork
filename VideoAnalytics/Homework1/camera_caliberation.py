...
board_w=5#int(sys.argv[1])	# number of horizontal corners
board_h=7#int(sys.argv[2])	# number of vertical corners
n_boards=1#int(sys.argv[3])
...
while(successes<n_boards):
	...
	cv.ShowImage("Test Frame1",gray_image)
	(found,corners)=cv.FindChessboardCorners(gray_image,board_sz,cv.CV_CALIB_CB_ADAPTIVE_THRESH | cv.CV_CALIB_CB_FILTER_QUADS | cv.CV_CALIB_CB_NORMALIZE_IMAGE)#| cv.CV_CALIB_CB_FILTER_QUADS

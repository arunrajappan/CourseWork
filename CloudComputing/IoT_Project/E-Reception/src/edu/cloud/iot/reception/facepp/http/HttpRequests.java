package edu.cloud.iot.reception.facepp.http;
...
import edu.cloud.iot.reception.facepp.error.FaceppParseException;
...
public class HttpRequests {
	...
	/**
	 * default is 30 sec set http timeout limit (million second)
	 * 
	 * @param timeOut
	 */
	 ...
	 */
	public JSONObject request(String control, String action)
	...
	// * @throws FaceppParseException
	// */
	// public FaceppResult train(PostParameters params) throws
	// FaceppParseException {
	// return train(params, TRAINTIMEOUT);
	// }
	//
	// /**
	// * timeout time is [timeOut]ms, the method is synchronized. <br />
	// * If training is success, return the result about
	// "/info/get_session?session_id=..". <br />
	...
	// * @throws FaceppParseException
	// */
	// public FaceppResult train(PostParameters params, long timeOut) throws
	// FaceppParseException {
	//
	...
	// while (true) {
	// FaceppResult rst = HttpRequests.this.request("info", "get_session", new
	 ...
	 * @throws FaceppParseException
	 */
	public JSONObject getSessionSync(String sessionId)
			throws FaceppParseException {
	 ...
	 * @throws FaceppParseException
	 */
	public JSONObject getSessionSync(String sessionId, long timeOut)
			throws FaceppParseException {
		final StringBuilder sb = new StringBuilder();
		long t = new Date().getTime() + timeOut;
		while (true) {
			JSONObject rst = HttpRequests.this.request("info", "get_session",
					new PostParameters().setSessionId(sessionId));
			try {
	 ...
	 */
	public JSONObject request(String control, String action,
			PostParameters params) throws FaceppParseException {
		URL url;
		...
		try {
			...
			Log.i("EDebug::apiKey = ", apiKey);
			Log.i("EDebug::apiSecret = ", apiSecret);
			...
			// FaceppResult result = new FaceppResult( new
			// JSONObject(resultString), urlConn.getResponseCode());
			...
			if (result.has("error")) {
				...
				throw new FaceppParseException("API error.",
						result.getInt("error_code"), result.getString("error"),
	...
	/**
	 * use https default create a empty {@link HttpRequests} object
	 */
	public HttpRequests() {
		super();
	}
	 ...
	 * @param isDebug
	 */
	public HttpRequests(String apiKey, String apiSecret, boolean isCN,
			boolean isDebug) {
		super();
		this.apiKey = apiKey;
		this.apiSecret = apiSecret;
	...
	/**
	 * used by offline detect example:
	 ...
	 * @throws FaceppParseException
	 */
	public JSONObject offlineDetect(byte[] image, String jsonResult)
			throws FaceppParseException {
	 ...
	 * used by offline detect example:
	 * request.offlineDetect(detecter.getImageByteArray(),
	 * detecter.getResultJsonString(), params);
	 * 
	 * @param image
	 * @param jsonResult
	 * @param params
	...
	public JSONObject detectionDetect(PostParameters params)
			throws FaceppParseException {
		return request("detection", "detect", params);
	}
	...
	public JSONObject detectionLandmark(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject trainVerify(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject trainSearch(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject trainIdentify(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject recognitionCompare(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject recognitionVerify(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject recognitionSearch(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject recognitionIdentify(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject groupingGrouping(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject personCreate(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject personDelete(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject personAddFace(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject personRemoveFace(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject personSetInfo(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject personGetInfo(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject facesetCreate(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject facesetDelete(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject facesetAddFace(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject facesetRemoveFace(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject facesetSetInfo(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject facesetGetInfo(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject groupCreate(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject groupDelete(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject groupAddPerson(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject groupRemovePerson(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject groupSetInfo(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject groupGetInfo(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject infoGetImage(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject infoGetFace(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject infoGetPersonList(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject infoGetFacesetList(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject infoGetGroupList(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject infoGetSession(PostParameters params)
			throws FaceppParseException {
	 ...
	 * @throws FaceppParseException
	 */
	public JSONObject infoGetQuota(PostParameters params)
			throws FaceppParseException {
	...
	public JSONObject infoGetApp(PostParameters params)
			throws FaceppParseException {

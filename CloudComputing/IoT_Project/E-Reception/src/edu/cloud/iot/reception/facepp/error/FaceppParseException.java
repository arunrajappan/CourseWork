package edu.cloud.iot.reception.facepp.error;
...
public class FaceppParseException extends Exception {
	...
	public FaceppParseException(String message, int errorCode,
			String errorMessage, int httpResponseCode) {
		super(message + " code=" + errorCode + ", message=" + errorMessage
